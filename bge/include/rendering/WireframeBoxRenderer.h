...
/**
 * Handles wireframe rendering of collider boxes
 */
class WireframeBoxRenderer
{
public:
  /**
   * Renders all existing collider boxes from the POV of the input camera
   ...
   * Most accurate mesh would be a box in this case.
...
private:
  Mesh m_BoxMesh;                        /**< The mesh to use for rendering */
